...
post_body = {
  "input_esdl_file_path": "file://C:/data/git/mmvib/opera-adapter/test/MACRO 7.esdl",
  "output_esdl_file_path": "file://C:/data/git/mmvib/opera-adapter/test/OperaOutput.esdl"
}
