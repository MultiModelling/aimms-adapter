...
<esdl:EnergySystem xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:esdl="http://www.tno.nl/esdl" esdlVersion="v2102" description="Solar panel" version="41" name="MACRO 13" id="3beab53e-f956-45ac-9fd0-05ba03fb3b84">
  <instance xsi:type="esdl:Instance" id="1cb40fb5-7c19-43b0-b88d-406aaaf2fbd3">
    ...
    <area xsi:type="esdl:Area" id="nl2019" name="Nederland">
      ...
      <asset xsi:type="esdl:MobilityDemand" id="7a45670d-5aba-405a-94e6-47ce6c141435" fuelType="HYDROGEN" aggregated="true" power="162737037.48245242" technicalLifetime="13.0" efficiency="1.35454" originalIdInSource="transport_car_using_hydrogen" name="MobilityDemand_h2Car_7a45" type="CAR">
        <geometry xsi:type="esdl:Point" lon="5.060577392578126" CRS="WGS84" lat="52.08894703028796"/>
        <dataSource xsi:type="esdl:DataSource" reference="https://github.com/quintel/etdataset/blob/master/nodes_source_analyses/energy/transport/transport_car_using_hydrogen.converter.xlsx" name="ETM"/>
      ...
      <asset xsi:type="esdl:MobilityDemand" id="c7a59334-5290-41dc-98b4-95a842344741" fuelType="HYDROGEN" aggregated="true" power="1346560876.7453334" technicalLifetime="12.0" efficiency="1.34274" originalIdInSource="transport_truck_using_hydrogen" name="MobilityDemand_h2Van_c7a5" type="TRUCK">
        <geometry xsi:type="esdl:Point" lon="5.060706138610841" CRS="WGS84" lat="52.091900237373906"/>
        <dataSource xsi:type="esdl:DataSource" reference="https://github.com/quintel/etdataset/blob/master/nodes_source_analyses/energy/transport/transport_truck_using_hydrogen.converter.xlsx" name="ETM"/>
      ...
      <asset xsi:type="esdl:MobilityDemand" id="ac31f9cb-9168-4b42-b620-e5d90e6c738d" fuelType="HYDROGEN" aggregated="true" power="547974648.266366" technicalLifetime="12.0" efficiency="0.03104" originalIdInSource="transport_van_using_hydrogen" name="MobilityDemand_h2Truck_ac31" type="VAN">
        <geometry xsi:type="esdl:Point" lon="5.066542625427247" CRS="WGS84" lat="52.091952971438346"/>
        <dataSource xsi:type="esdl:DataSource" reference="https://github.com/quintel/etdataset/blob/master/nodes_source_analyses/energy/transport/transport_van_using_hydrogen.converter.xlsx" name="ETM"/>
      ...
      <asset xsi:type="esdl:Electrolyzer" power="10000000.0" fullLoadHours="2989" technicalLifetime="25.0" efficiency="0.67" originalIdInSource="energy_hydrogen_flexibility_p2g_electricity" name="Electrolyzer_b243" id="b243c807-ce6a-4625-8d24-7c2b57ac1ce3">
        <geometry xsi:type="esdl:Point" lon="5.064654350280763" lat="52.08849875855484"/>
        <dataSource xsi:type="esdl:DataSource" reference="https://github.com/quintel/etdataset-public/blob/master/nodes_source_analyses/energy/energy/energy_hydrogen_flexibility_p2g_electricity.converter.xlsx" name="ETM"/>
        ...
        <costInformation xsi:type="esdl:CostInformation">
          ...
          <fixedOperationalAndMaintenanceCosts xsi:type="esdl:SingleValue" value="20.0" name="Fixed operation and maintenance costs (per year)" interpolationMethod="NONE">
            <profileQuantityAndUnit xsi:type="esdl:QuantityAndUnitType" perTimeUnit="YEAR" description="Cost in EUR/kW/yr" perUnit="WATT" perMultiplier="KILO" unit="EURO" physicalQuantity="COST"/>
      ...
      <asset xsi:type="esdl:Import" power="5000000.0" fullLoadHours="2000" name="Import_a3ac" id="a3ac6459-54f5-4345-95bd-3384d1a976e1">
        <geometry xsi:type="esdl:Point" lon="5.0737953186035165" CRS="WGS84" lat="52.089975401365436"/>
      ...
      <asset xsi:type="esdl:WindTurbine" technicalLifetime="25.0" originalIdInSource="energy_power_wind_turbine_inland or energy_power_wind_turbine_coastal" surfaceArea="200000" fullLoadHours="3000" power="3000000.0" name="WindTurbine_6411" id="64119197-a2d1-49d9-971a-08b978b99448">
        <geometry xsi:type="esdl:Point" lon="5.067787170410157" CRS="WGS84" lat="52.08615185068389"/>
        <dataSource xsi:type="esdl:DataSource" reference="https://github.com/quintel/etdataset-public/blob/master/nodes_source_analyses/energy/energy/energy_power_wind_turbine_inland.central_producer.xlsx" name="ETM"/>
      ...
      <asset xsi:type="esdl:PVPark" technicalLifetime="25.0" panelEfficiency="0.17" originalIdInSource="energy_power_solar_pv_solar_radiation" surfaceArea="113328" fullLoadHours="867" power="11332800.0" name="PVPark_37e4" id="37e43704-0b9e-49a3-97da-99f25c50ff7e">
        ...
        <dataSource xsi:type="esdl:DataSource" reference="https://github.com/quintel/etdataset-public/blob/master/nodes_source_analyses/energy/energy/energy_chp_local_engine_biogas.xlsx" name="ETM"/>
        ...
        <costInformation xsi:type="esdl:CostInformation">
          <fixedOperationalAndMaintenanceCosts xsi:type="esdl:SingleValue" id="148ea2fe-f67d-4fd1-a6a0-a67d66ad974d" value="12.0">
            <profileQuantityAndUnit xsi:type="esdl:QuantityAndUnitType" perTimeUnit="YEAR" description="Cost in EUR/kW/yr" perUnit="WATT" perMultiplier="KILO" unit="EURO" physicalQuantity="COST" id="77b9af3d-8ea7-4a49-894e-7d35a2b68987"/>
          </fixedOperationalAndMaintenanceCosts>
      ...
      <asset xsi:type="esdl:Battery" capacity="2.2e+16" maxDischargeRate="2444444444444.0" maxChargeRate="2444444444444.0" selfDischargeRate="7610361.111" dischargeEfficiency="1.0" name="Battery_082c" chargeEfficiency="0.8475" id="082ce57c-5559-42f9-8f4f-51a11195994b">
        <geometry xsi:type="esdl:Point" lon="5.0556421279907235" lat="52.085083834889716"/>
        ...
        <costInformation xsi:type="esdl:CostInformation" id="3db45f76-5dd6-4820-8657-f15693de819e">
          ...
          <fixedOperationalAndMaintenanceCosts xsi:type="esdl:SingleValue" id="455ba551-291f-4966-9750-60b3b379b256" value="0.003514">
            <profileQuantityAndUnit xsi:type="esdl:QuantityAndUnitType" perTimeUnit="YEAR" description="Cost in EUR/kW/yr" perUnit="WATT" perMultiplier="KILO" unit="EURO" physicalQuantity="COST" id="e7ae9f2a-1214-4028-9e2e-016a84e9c153"/>
          </fixedOperationalAndMaintenanceCosts>
      ...
      <asset xsi:type="esdl:PowerPlant" fuel="URANIUM" power="15000000.0" efficiency="1.0" name="NuclearPowerPlant_f521" id="f521a519-9c80-4661-a66c-e6a035adce2c">
        <geometry xsi:type="esdl:Point" lon="5.07345199584961" lat="52.08789226610088"/>
        ...
        <costInformation xsi:type="esdl:CostInformation" id="ea2fafa9-0fd2-419d-b9ff-f55542816edb">
          ...
          <fixedOperationalAndMaintenanceCosts xsi:type="esdl:SingleValue" id="3b30600f-4dae-48c4-a8d4-b3b39f9d222e" value="77.0">
            <profileQuantityAndUnit xsi:type="esdl:QuantityAndUnitType" perTimeUnit="YEAR" description="Cost in EUR/kW/yr" perUnit="WATT" perMultiplier="KILO" unit="EURO" physicalQuantity="COST" id="5793ba81-596d-4f60-b5ab-923d361416c3"/>
          </fixedOperationalAndMaintenanceCosts>
      ...
      <asset xsi:type="esdl:ElectricityNetwork" name="ElectricityNetwork_db77" id="db777383-6bd8-4e34-b38b-8e98e58c1f86">
        <geometry xsi:type="esdl:Point" lon="5.057702064514161" lat="52.087285765403685"/>
        ...
        <port xsi:type="esdl:OutPort" connectedTo="b5aa0e4d-fc6d-460a-beaa-d99132712776 1420751d-903f-4f6a-96d9-1a608438cb56 b772afcc-c499-447c-b271-85a78a7ad6b3 7cc24dd1-04ba-47d0-af5c-d89343248edf" name="Out" id="0333a271-111b-4d95-9c34-1ab84bff565e" carrier="67d4305b-4a8c-4163-be55-087bb77a3663"/>
      </asset>
      <asset xsi:type="esdl:ElectricityCable" length="309.5" name="ElectricityCable_d1de" id="d1deef89-6f2e-4c71-9de0-7f0009654164">
        <geometry xsi:type="esdl:Line" CRS="WGS84">
          ...
          <point xsi:type="esdl:Point" lon="5.057702064514161" lat="52.087285765403685"/>
        </geometry>
      ...
      <asset xsi:type="esdl:MobilityDemand" fuelType="ELECTRICITY" type="TRUCK" name="MobilityDemand_eTruck_b8df" id="b8dfbde7-f92c-49d4-ad14-e24c7e0d860d">
        <geometry xsi:type="esdl:Point" lon="5.053603649139405" lat="52.08968535038432"/>
      ...
      <asset xsi:type="esdl:MobilityDemand" fuelType="ELECTRICITY" type="VAN" name="MobilityDemand_eVan_3b7d" id="3b7d3605-7617-4840-afd3-14bc761b7a38">
        <geometry xsi:type="esdl:Point" lon="5.051844120025636" lat="52.08878881724934"/>
      ...
      <asset xsi:type="esdl:MobilityDemand" fuelType="ELECTRICITY" type="CAR" name="MobilityDemand_eCar_e584" id="e584f0f7-3a7c-49a1-a0de-6609abf5166b">
        <geometry xsi:type="esdl:Point" lon="5.052552223205566" lat="52.08747035344503"/>
      ...
      <asset xsi:type="esdl:ElectricityCable" length="361.9" name="ElectricityCable_95f7" id="95f746ae-eb42-4821-9e81-649a1057d0d0">
        <geometry xsi:type="esdl:Line" CRS="WGS84">
          <point xsi:type="esdl:Point" lon="5.057702064514161" lat="52.087285765403685"/>
          <point xsi:type="esdl:Point" lon="5.053882598876953" lat="52.08954032418669"/>
        </geometry>
      ...
      <asset xsi:type="esdl:ElectricityCable" length="408.9" name="ElectricityCable_dd65" id="dd65c274-7139-4437-9ff6-2e204112fec8">
        <geometry xsi:type="esdl:Line" CRS="WGS84">
          <point xsi:type="esdl:Point" lon="5.057702064514161" lat="52.087285765403685"/>
          <point xsi:type="esdl:Point" lon="5.052165985107423" lat="52.08868334157857"/>
        </geometry>
      ...
      <asset xsi:type="esdl:ElectricityCable" length="324.4" name="ElectricityCable_76c8" id="76c843a9-81a9-4e7d-acb9-3ae4262fabeb">
        <geometry xsi:type="esdl:Line" CRS="WGS84">
          <point xsi:type="esdl:Point" lon="5.057702064514161" lat="52.087285765403685"/>
          <point xsi:type="esdl:Point" lon="5.052959918975831" lat="52.087430798929006"/>
        </geometry>
      ...
      <asset xsi:type="esdl:ElectricityCable" length="253.5" name="ElectricityCable_8ba7" id="8ba73979-f258-4acc-9491-21eb03318904">
        <geometry xsi:type="esdl:Line" CRS="WGS84">
          <point xsi:type="esdl:Point" lon="5.057702064514161" lat="52.087285765403685"/>
          <point xsi:type="esdl:Point" lon="5.055856704711915" lat="52.08530798847198"/>
        </geometry>
        <port xsi:type="esdl:InPort" id="8e9135c7-5c07-4d61-8c36-83f1a94b79d5" carrier="67d4305b-4a8c-4163-be55-087bb77a3663" name="Port"/>
      ...
      <asset xsi:type="esdl:ElectricityCable" length="1078.2" name="ElectricityCable_9e89" id="9e891e39-3905-4bd3-acd9-362c6116fa91">
        <geometry xsi:type="esdl:Line" CRS="WGS84">
          <point xsi:type="esdl:Point" lon="5.07345199584961" lat="52.08789226610088"/>
          <point xsi:type="esdl:Point" lon="5.057702064514161" lat="52.087285765403685"/>
        </geometry>
